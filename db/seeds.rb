...
unless Account.first(:username => "fglenanne")
  account = Account.create(:username => "fglenanne", :email => "fglenanne@padrino.com", :name => "Fiona", :surname => "Glenanne", :password => "password", :password_confirmation => "password", :role => "user", :last_update => DateTime.now )
end

unless Account.first(:username => "saxe")
  account = Account.create(:username => "saxe", :email => "saxe@padrino.com", :name => "Sam", :surname => "Axe", :password => "password", :password_confirmation => "password", :role => "user", :last_update => DateTime.now )
end

unless Account.first(:username => "jporter")
  account = Account.create(:username => "jporter", :email => "jporter@padrino.com", :name => "Jesse", :surname => "Porter", :password => "password", :password_confirmation => "password", :role => "user", :last_update => DateTime.now )
end
